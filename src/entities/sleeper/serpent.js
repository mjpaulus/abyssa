// THE SERPENT — the original sleeper: one continuous deformed body carrying the wards.
...
export function makeSerpent(idx, cfg) {
  ...
  L.onDispose = () => disposeSerpentExtras(L);
  updateSpine(L);
  scene.add(grp);
  setLive(L);
...
export function updateSerpent(L, dt, t, player) {
